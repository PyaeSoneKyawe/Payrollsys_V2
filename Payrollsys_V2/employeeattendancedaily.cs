...
namespace Payrollsys_V2
{
    class employeeattendancedaily
    {
        ...
        public bool insertempatt(int id, string nm, DateTime dt, DateTime tin, DateTime tout, DateTime wh, DateTime oth, DateTime late,int state)
        {
        ...
        public bool editempatt(int eid,int id, String nm, DateTime dt, DateTime tin, DateTime tout, DateTime wh, DateTime oth, DateTime late, int state)
        {
